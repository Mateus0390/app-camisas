...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, alertCtrl) {
        ...
        this.vetor = ['Camisa do São Paulo', 'Camisa do Palmeiras', 'Camisa do Barcelona'];
        this.vetor2 = [
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        var novaCamisa = { foto: data.foto, nome: data.nome, numero: data.numero, preco: data.preco };
                        _this.vetor2.push(novaCamisa);
                    }
                }
            ]
        });
    ...
    HomePage.prototype.excluir = function (item) {
        ...
        for (var i = 0; i < this.vetor2.length; i++) {
            var element = this.vetor2[i];
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\mateus\Downloads\app1\myApp\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>\n      <ion-icon name="shirt" style="margin-right: 8px;"></ion-icon>\n      Camisas de Futebol\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="page-home">\n  <button ion-button icon-start block (click)="showPrompt()">Adicionar Camisas</button>\n  <ion-list>\n    <ion-item *ngFor="let item of vetor2">\n      <ion-thumbnail item-start>\n        <img src="{{item.foto}}" alt="Camisa">\n      </ion-thumbnail>\n      <h2>{{item.nome}}</h2>\n      <p>Nº: {{item.numero}}</p>\n      <p>Preço: {{item.preco}}</p>\n      <button ion-button clear item-end color="danger" (click)="showConfirm(item)">Excluir</button>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\mateus\Downloads\app1\myApp\src\pages\home\home.html"*/
        }),
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"C:\Users\mateus\Downloads\app1\myApp\src\pages\list\list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"C:\Users\mateus\Downloads\app1\myApp\src\pages\list\list.html"*/
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\mateus\Downloads\app1\myApp\src\app\app.html"*/'<ion-menu [content]="content" type="overlay">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\Users\mateus\Downloads\app1\myApp\src\app\app.html"*/
        }),
